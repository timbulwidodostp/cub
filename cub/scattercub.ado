********************************************************************************
*! "scattercub", v.29, Cerulli, 14dic2021
********************************************************************************
...
********************************************************************************
qui scatter Feeling Uncertainty , mlabel(_ID) name(gr_scatt , replace) saving(`save_graph',replace)
********************************************************************************
if "`save_data'"!=""{
qui keep _ID Feeling Uncertainty
qui save `save_data' , replace
qui drop if _ID!="."
}
restore
end
