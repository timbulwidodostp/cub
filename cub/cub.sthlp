...
{cmd:m}{cmd:(}{it:#}{cmd:)}
{cmd:prob}{cmd:(}{it:newvarname}{cmd:)}
{cmd:graph}
...
{phang} {cmd:prob}{cmd:(}{it:newvarname}{cmd:)} allows to generate a new variable containing the model fitted probabilities.

{phang} {cmd:graph} allows to generate a graph displaying a plot of the actual and predicted probabilities.  

{phang} {cmd:outname}{cmd:(}{it:name}{cmd:)} allows to specify a convenient name for the outcome variable to appear in the graph, when the 'graph' option is invoked.  

{phang} {cmd:save_graph}{cmd:(}{it:filename}{cmd:)} allows to save the graph generated by the 'graph' option. 
...
{psee}
Online: {helpb scattercub} , {helpb glm}
{p_end}
